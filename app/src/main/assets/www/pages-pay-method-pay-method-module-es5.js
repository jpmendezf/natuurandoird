...
var PayMethodPageModule = /** @class */ (function () {
    function PayMethodPageModule() {
    }
...
var PayMethodPage = /** @class */ (function () {
    function PayMethodPage(api, util, gpi, payPal, modalController) {
        var _this = this;
        this.api = api;
        this.util = util;
        this.gpi = gpi;
    ...
    PayMethodPage.prototype.ngOnInit = function () { };
    PayMethodPage.prototype.paymentMethod = function () {
        var _this = this;
        /*
        return */
        var rdata = {};
        ...
        this.gpi.cartData.forEach(function (element) {
        ...
        if (this.online) {
            ...
            this.util.startLoad();
            this.api.postDataWithToken("createGroceryOrder", rdata).subscribe(function (res) {
                if (res.success) {
                    _this.util.dismissLoader();
                    _this.gpi.promocode = {};
                    _this.gpi.orderId = res.data.id;
                    _this.presentModal();
                }
            }, function (err) {
    ...
    PayMethodPage.prototype.payWithRazor = function (rdata) {
        var _this = this;
        var options = {
        ...
        var successCallback = function (payment_id) {
            ...
            _this.api.postDataWithToken("createGroceryOrder", rdata).subscribe(function (res) {
                if (res.success) {
                    _this.util.dismissLoader();
                    _this.gpi.promocode = {};
                    _this.gpi.orderId = res.data.id;
    ...
    PayMethodPage.prototype.paypalPay = function (rdata) {
        var _this = this;
        this.payPal
            .init({
            ...
            _this.payPal
                ...
                .then(function () {
                var payment = new _ionic_native_paypal_ngx__WEBPACK_IMPORTED_MODULE_7__["PayPalPayment"](_this.gpi.info.toPay, _this.currencyType, "Description", "sale");
    ...
    PayMethodPage.prototype.presentModal = function () {
    ...
    PayMethodPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-pay-method-pay-method-module-es5.js.map