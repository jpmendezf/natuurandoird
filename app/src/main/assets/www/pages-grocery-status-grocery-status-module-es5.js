...
var GroceryStatusPageModule = /** @class */ (function () {
    function GroceryStatusPageModule() {
    }
    ...
    return GroceryStatusPageModule;
}());
...
var GroceryStatusPage = /** @class */ (function () {
    function GroceryStatusPage(nav, api, util, gpi) {
        var _this = this;
        this.nav = nav;
        this.api = api;
        this.util = util;
        ...
        this.api
            ...
            if (res.success) {
                ...
                if (_this.data.order_status == "Pending" ||
                ...
                else if (_this.data.order_status == "DriverApproved") {
                    _this.status = 1;
                }
                else if (_this.data.order_status == "OrderReady" ||
                    _this.data.order_status == "PickUpGrocery") {
                    _this.status = 2;
                }
                else if (_this.data.order_status == "OutOfDelivery") {
                    _this.status = 3;
                }
                    ...
                    if (_this.data.order_status != "Cancel") {
                        _this.status = 5;
                    }
                }
            }
            ...
            _this.util.dismissLoader();
            _this.util.presentToast("something went wrong");
        });
    ...
    GroceryStatusPage.prototype.ngOnInit = function () { };
    GroceryStatusPage.prototype.orderStatus = function () {
        this.nav.navigateForward("grocery-order-detail");
    };
    GroceryStatusPage.prototype.getlocation = function () {
        var _this = this;
        this.api
            .getDataWithToken("trackGroceryOrder/" + this.gpi.orderId)
            .subscribe(function (res) {
    ...
    GroceryStatusPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-grocery-status-grocery-status-module-es5.js.map