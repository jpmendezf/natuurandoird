...
var ProductPage = /** @class */ (function () {
    function ProductPage(nav, popoverController, api, util, gpi) {
        this.nav = nav;
    ...
    ProductPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        this.util.startLoad();
        this.api.getDataWithToken("groceryItem/" + this.gpi.storeID).subscribe(function (res) {
            if (res.success) {
                _this.util.dismissLoader();
                _this.Store = res.data;
                console.log(_this.Store);
                _this.cartData = _this.gpi.cartData;
                _this.getdata();
            }
        }, function (err) {
            _this.util.dismissLoader();
    ...
    ProductPage.prototype.storeDetail = function (id) {
        this.gpi.itemId = id;
        this.nav.navigateForward("/product-detail");
    };
    ProductPage.prototype.presentPopover = function (ev) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        popover = _a.sent();
                        popover.onWillDismiss().then(function (res) {
                            if (res.data) {
                                if (res.data == "hightolow") {
                                    _this.Store.sort(function (a, b) { return (a.sell_price < b.sell_price ? 1 : -1); });
                                    _this.sortType = "hightolow";
                                }
                                else {
                                    _this.Store.sort(function (a, b) { return (a.sell_price > b.sell_price ? 1 : -1); });
                                    _this.sortType = "lowtohigh";
                                }
                            }
                        });
        ...
        if (this.gpi.cartData) {
            if (this.gpi.cartData.length >= 0) {
                if (this.Store) {
                    ...
                    this.Store.forEach(function (el1) {
                        el1.qty = 0;
    ...
    ProductPage.prototype.AddCart = function (item) {
        item.qty = item.qty + 1;
    ...
    ProductPage.prototype.remove = function (item) {
        var equalIndex;
        if (item.qty == 0)
            return;
        item.qty = item.qty - 1;
    ...
    ProductPage.prototype.cart = function () {
