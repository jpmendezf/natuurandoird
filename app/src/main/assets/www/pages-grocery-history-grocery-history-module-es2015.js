...
let GroceryHistoryPageModule = class GroceryHistoryPageModule {
};
...
let GroceryHistoryPage = class GroceryHistoryPage {
    constructor(nav, api, gpi, util) {
        this.nav = nav;
        this.api = api;
        this.gpi = gpi;
        this.util = util;
        ...
        this.util.startLoad();
        this.api.getDataWithToken("groceryOrder").subscribe((res) => {
            if (res.success) {
...
GroceryHistoryPage.ctorParameters = () => [
...
//# sourceMappingURL=pages-grocery-history-grocery-history-module-es2015.js.map