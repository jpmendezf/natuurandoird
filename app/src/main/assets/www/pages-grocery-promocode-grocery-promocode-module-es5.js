...
var GroceryPromocodePageModule = /** @class */ (function () {
    function GroceryPromocodePageModule() {
    }
    ...
    return GroceryPromocodePageModule;
}());
...
var GroceryPromocodePage = /** @class */ (function () {
    function GroceryPromocodePage(api, util, gpi, ntrl) {
        var _this = this;
        this.api = api;
        this.util = util;
        this.gpi = gpi;
        ...
        this.api
            ...
            _this.util.dismissLoader();
            _this.util.presentToast("somethig went wrong");
        });
    }
    GroceryPromocodePage.prototype.ngOnInit = function () { };
    GroceryPromocodePage.prototype.applyPromocode = function (item) {
        var _this = this;
        var promocode = {};
        promocode.code = item.code;
        this.util.startLoad();
        this.api.postDataWithToken("chkCoupon", promocode).subscribe(function (res) {
            if (res.success) {
                _this.util.dismissLoader();
                _this.gpi.promocode = item;
                _this.ntrl.back();
            }
            else {
                _this.util.dismissLoader();
    ...
    GroceryPromocodePage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-grocery-promocode-grocery-promocode-module-es5.js.map