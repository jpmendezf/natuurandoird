...
var ForgotPage = /** @class */ (function () {
    function ForgotPage(ntrl, api, util) {
        this.ntrl = ntrl;
        this.api = api;
        this.util = util;
        this.data = {};
    ...
    ForgotPage.prototype.Sendpassword = function () {
        var _this = this;
        this.util.startLoad();
        this.api.postData("forgetPassword", this.data).subscribe(function (res) {
            if (res.success) {
                _this.util.dismissLoader();
                _this.util.presentToast(res.msg);
                _this.ntrl.navigateForward(["login"]);
            }
        }, function (err) {
            if (err.error.msg) {
    ...
    ForgotPage.prototype.backPage = function () {
        this.ntrl.back();
    };
