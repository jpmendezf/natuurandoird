...
let OrderHistoryPage = class OrderHistoryPage {
    constructor(ntrl, api, alertController, util, translate) {
        this.ntrl = ntrl;
        this.api = api;
    ...
    ionViewWillEnter() {
        ...
        this.util.startLoad();
        this.api.getDataWithToken("userOrder").subscribe((res) => {
            if (res.success) {
                this.data = res.data;
                    ...
                    buttons: [
                        {
                            ...
                            handler: () => {
                                this.util.startLoad();
                                this.api.getDataWithToken("cancelOrder/" + id).subscribe((res) => {
                                    if (res.success) {
