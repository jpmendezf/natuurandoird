...
var OrderDetailPage = /** @class */ (function () {
    function OrderDetailPage(ntrl, api, util, translate) {
        var _this = this;
        this.ntrl = ntrl;
        this.api = api;
        this.util = util;
        ...
        this.util.startLoad();
        this.api.getDataWithToken("singleOrder/" + this.api.orderID).subscribe(function (res) {
            if (res.success) {
                _this.util.dismissLoader();
                _this.data = res.data;
                _this.itemtotal = 0;
                _this.data.orderItems.forEach(function (element) {
                    _this.itemtotal = _this.itemtotal + element.price;
                    _this.data.item_review.forEach(function (elreview) {
                ...
                if (res.data.shopReview_status) {
                    _this.shopReview = res.data.shop_review;
                }
                if (res.data.driverReview_status) {
                    _this.driverReview = res.data.driver_review;
                }
            }
        }, function (err) {
            _this.util.dismissLoader();
    ...
    OrderDetailPage.prototype.onSubmit = function (item) {
        var _this = this;
        ...
        item.forEach(function (element) {
            if (element.package_id) {
                ...
                _this.itemReview.itemData.push(pusher);
            }
            else {
                var pusher = {
        ...
        this.api
            ...
            if (res.success) {
                ...
                _this.data.review_status = 1;
            }
        });
    };
    OrderDetailPage.prototype.shopReiviewData = function (item) {
        var _this = this;
        ...
        this.api
            ...
            if (res.success) {
                ...
                _this.data.shopReview_status = 1;
            }
        });
    };
    OrderDetailPage.prototype.orderStatus = function (id) {
        this.api.checkOrderStatus = id;
        this.ntrl.navigateForward("/timeline");
    };
    OrderDetailPage.prototype.driverReviewData = function (item) {
        var _this = this;
        ...
        this.api.postDataWithToken("addDriverReview", this.driverReview).subscribe(function (res) {
            if (res.success) {
                _this.err = {};
                _this.translate.get('toasts').subscribe(function (val) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                _this.data.driverReview_status = 1;
            }
        }, function (err) {
