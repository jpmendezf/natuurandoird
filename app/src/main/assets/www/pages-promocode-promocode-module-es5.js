...
var PromocodePageModule = /** @class */ (function () {
    function PromocodePageModule() {
    }
...
var PromocodePage = /** @class */ (function () {
    function PromocodePage(ntrl, api, util, route) {
        var _this = this;
        this.ntrl = ntrl;
        this.api = api;
        this.util = util;
        ...
        this.route.params.subscribe(function (params) {
            ...
            if (_this.isfrom == "menu") {
                _this.util.startLoad();
                _this.api.getDataWithToken("viewCoupon").subscribe(function (res) {
                    if (res.success) {
                        _this.data = res.data;
                ...
                _this.util.startLoad();
                _this.api
                    .getDataWithToken("viewShopCoupon/" + _this.isfrom)
    ...
    PromocodePage.prototype.ngOnInit = function () { };
    PromocodePage.prototype.back = function () {
        this.ntrl.back();
    };
    PromocodePage.prototype.applyPromocode = function (item) {
        var _this = this;
    ...
    PromocodePage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-promocode-promocode-module-es5.js.map