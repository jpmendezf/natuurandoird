...
let SelectAddressPage = class SelectAddressPage {
    constructor(modalController, api, util, ntrl, translate) {
        ...
        this.util.startLoad();
        this.api.getDataWithToken("userAddress").subscribe((res) => {
            if (res.success) {
...
//# sourceMappingURL=pages-select-address-select-address-module-es2015.js.map