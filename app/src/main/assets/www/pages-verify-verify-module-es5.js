...
var VerifyPage = /** @class */ (function () {
    function VerifyPage(menu, nav, api, util) {
        this.menu = menu;
        this.nav = nav;
        this.api = api;
        this.util = util;
    ...
    VerifyPage.prototype.getOtp = function () {
        var _this = this;
        this.util.startLoad();
        this.api.postData("verifyPhone", this.data).subscribe(function (res) {
            if (res.success) {
                _this.util.dismissLoader();
                _this.util.presentToast(res.msg);
                _this.api.verifynumber = _this.data.phone;
                _this.api.verifynuberCode = _this.data.code;
                _this.nav.navigateRoot("get-otp");
            }
            else {
                _this.err = {};
                _this.util.dismissLoader();
