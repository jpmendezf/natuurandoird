...
var HelpCenterPage = /** @class */ (function () {
    function HelpCenterPage(ntrl) {
        this.ntrl = ntrl;
    }
    HelpCenterPage.prototype.ngOnInit = function () {
    };
    HelpCenterPage.prototype.back = function () {
        this.ntrl.back();
    };
    HelpCenterPage.prototype.profile = function () {
        this.ntrl.navigateForward(['profile']);
    };
    HelpCenterPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-help-center-help-center-module-es5.js.map