...
var HomePage = /** @class */ (function () {
    function HomePage(menu, modalController, navCtrl, nativeGeocoder, api, util, gpi, geolocation) {
        var _this = this;
        this.menu = menu;
        ...
        this.api.getData("keySetting").subscribe(function (res) {
            _this.sellProduct = res.data.sell_product;
            if (_this.sellProduct == 2) {
                _this.isfood = false;
            }
            _this.initData();
        }, function (err) {
    ...
    HomePage.prototype.initData = function () {
        ...
        this.util.startLoad();
        this.api.getDataWithToken("home").subscribe(function (res) {
            if (res.success) {
                _this.data = res.data;
                _this.currency = _this.api.currency;
                _this.getGrocery();
            }
        }, function (err) {
    ...
    HomePage.prototype.getAdvertisingBanner = function () {
        var _this = this;
        this.api.getData("banner").subscribe(function (res) {
            if (res.success) {
    ...
    HomePage.prototype.ionViewWillEnter = function () {
        ...
        if (localStorage.getItem("isaddress") != "false") {
            ...
            this.geolocation
                ...
                _this.userAddress.lat = resp.coords.latitude;
                _this.userAddress.lang = resp.coords.longitude;
                var options = {
                    useLocale: true,
                    maxResults: 5,
                };
                _this.nativeGeocoder
                    .reverseGeocode(resp.coords.latitude, resp.coords.longitude, options)
                    .then(function (result) {
                    _this.util.dismissLoader();
                    _this.userAddress.address_type = "Current Location";
                    _this.userAddress.soc_name = result[0].subLocality;
                    _this.userAddress.street = result[0].thoroughfare;
                    _this.userAddress.city = result[0].locality;
                    _this.userAddress.zipcode = result[0].postalCode;
                })
                            ...
                            if (res["data"] != undefined) {
                                ...
                                res.data.forEach(function (element) {
                                    if (element.checked == true) {
                                        filetype_1 = element.name;
                                    }
                                });
                                if (filetype_1 == "Cost High to Low") {
                                    _this.data.shop.sort(function (a, b) {
                                ...
                                else if (filetype_1 == "Top Rated" || filetype_1 == "Most Popular") {
                                    _this.data.shop.sort(function (a, b) {
                                        if (a.rate > b.rate) {
                                            return -1;
                                        }
                                ...
                                else if (filetype_1 == "Cost Low to High") {
                                    _this.data.shop.sort(function (a, b) {
                                        if (a.avarage_plate_price < b.avarage_plate_price) {
                                            return -1;
                                        }
                                ...
                                else if (filetype_1 == "Open Now") {
                                    _this.currentTime = moment__WEBPACK_IMPORTED_MODULE_5__().format("HH:mm");
                                    _this.data.shop = _this.data.shop.filter(function (a) {
                                        ...
                                        if (_this.currentTime >= a.open_time &&
                                            _this.currentTime <= a.close_time) {
                                            return a;
                                        }
                                    });
                                }
                                    ...
                                    if (localStorage.getItem("isaddress") != "false") {
                                        _this.api
                                            ...
                                            if (res.success) {
                                                ...
                                                _this.nativeGeocoder
                                                    .forwardGeocode(_this.Address, options)
                                                    .then(function (result) {
                                                    _this.data.shop.forEach(function (element) {
                                                        element.distance = _this.distance(result[0].latitude, result[0].longitude, element.latitude, element.longitude, "K");
                                                    });
                                                    _this.data.shop.sort(function (a, b) {
                                        ...
                                        _this.nativeGeocoder
                                            .forwardGeocode(_this.userAddress, options)
                                            .then(function (result) {
                                            _this.data.shop.forEach(function (element) {
                                                element.distance = _this.distance(result[0].latitude, result[0].longitude, element.latitude, element.longitude, "K");
                                            });
    ...
    HomePage.prototype.resturantDetail = function (id) {
    ...
    HomePage.prototype.feature = function (type) {
        if (type) {
    ...
    HomePage.prototype.categoryData = function (id) {
        this.navCtrl.navigateForward("/category/" + id);
    };
    HomePage.prototype.getGrocery = function () {
        var _this = this;
        this.api.getDataWithToken("groceryShop").subscribe(function (res) {
            if (res.success) {
                _this.grocery.Store = res.data.shop;
                _this.grocery.coupon = res.data.coupon;
                _this.api.getDataWithToken("groceryCategory").subscribe(function (res) {
                    if (res.success) {
                        _this.util.dismissLoader();
                        _this.grocery.category = res.data;
                        _this.grocery.Store.forEach(function (element) {
    ...
    HomePage.prototype.storeList = function () {
        this.navCtrl.navigateForward("store");
    };
    HomePage.prototype.storeDetail = function (id) {
        this.gpi.storeID = id;
        this.navCtrl.navigateForward("/store-detail");
    };
    HomePage.prototype.subcategory = function (id) {
        this.gpi.catId = id;
        this.navCtrl.navigateForward("store");
    };
