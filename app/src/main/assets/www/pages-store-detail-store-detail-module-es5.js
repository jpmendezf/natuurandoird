...
var StoreDetailPageModule = /** @class */ (function () {
...
var StoreDetailPage = /** @class */ (function () {
    function StoreDetailPage(nav, api, util, gpi) {
        var _this = this;
        this.nav = nav;
        this.api = api;
        this.util = util;
        ...
        this.api
            ...
            if (res.success) {
                _this.data = res.data;
                _this.api
                    .getDataWithToken("groceryShopCategory/" + _this.gpi.storeID)
                    .subscribe(function (res) {
                    if (res.success) {
                        _this.data.category = res.data;
                        _this.api
                            .getDataWithToken("groceryItem/" + _this.gpi.storeID)
                            .subscribe(function (res) {
                            if (res.success) {
                                _this.util.dismissLoader();
                                _this.data.product = res.data;
                                _this.id = res.data.id;
                                _this.data.product.forEach(function (element) {
                                    element.qty = 0;
                                    if (_this.cartData.length > 0) {
                                        var fCart = _this.cartData.find(function (x) { return x.id == element.id; });
                                        if (fCart) {
    ...
    StoreDetailPage.prototype.AddCart = function (item) {
        item.qty = item.qty + 1;
    ...
    StoreDetailPage.prototype.remove = function (item) {
        var equalIndex;
        if (item.qty == 0)
            return;
        item.qty = item.qty - 1;
    ...
    StoreDetailPage.prototype.ngOnInit = function () { };
    StoreDetailPage.prototype.viewMore = function () {
        this.nav.navigateForward("product");
    };
    StoreDetailPage.prototype.subcategory = function (id) {
        this.gpi.catId = id;
        this.nav.navigateForward("/category-detail");
    };
    StoreDetailPage.prototype.cart = function () {
    ...
    StoreDetailPage.prototype.ionViewWillLeave = function () {
        this.gpi.cartData = this.cartData;
    };
    StoreDetailPage.prototype.storeDetail = function (id) {
        this.gpi.itemId = id;
        this.nav.navigateForward("/product-detail");
    };
    StoreDetailPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        this.cartData = JSON.parse(localStorage.getItem("store-detail")) || [];
        if (this.cartData.length > 0) {
            if (this.data.product.length > 0) {
                this.data.product.forEach(function (el1) {
                    var fCart = _this.cartData.find(function (x) { return x.id == el1.id; });
                    if (fCart) {
                        el1.qty = fCart.qty;
                    }
                    else {
    ...
    StoreDetailPage.prototype.logScrolling = function (ev) {
    ...
    StoreDetailPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-store-detail-store-detail-module-es5.js.map