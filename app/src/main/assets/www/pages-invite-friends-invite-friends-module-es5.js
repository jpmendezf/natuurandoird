...
var InviteFriendsPageModule = /** @class */ (function () {
...
var InviteFriendsPage = /** @class */ (function () {
    function InviteFriendsPage(ntrl, api, socialSharing, util) {
        var _this = this;
        this.ntrl = ntrl;
        this.api = api;
        ...
        this.util = util;
        this.util.startLoad();
        this.api.getDataWithToken("friendsCode").subscribe(function (res) {
            if (res.success) {
                _this.data = res.data;
    ...
    InviteFriendsPage.prototype.ngOnInit = function () { };
    InviteFriendsPage.prototype.back = function () {
        this.ntrl.back();
    };
    InviteFriendsPage.prototype.shareIt = function () {
        this.socialSharing
    ...
    InviteFriendsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-invite-friends-invite-friends-module-es5.js.map