...
var CategoryDetailPageModule = /** @class */ (function () {
...
var CategoryDetailPage = /** @class */ (function () {
    function CategoryDetailPage(api, util, gpi, nav) {
        this.api = api;
        this.util = util;
        this.gpi = gpi;
        this.nav = nav;
    ...
    CategoryDetailPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        this.util.startLoad();
        this.api.getDataWithToken("grocerySubCategory/" + this.gpi.catId).subscribe(function (res) {
    ...
    CategoryDetailPage.prototype.ngOnInit = function () { };
    CategoryDetailPage.prototype.getdata = function () {
        var _this = this;
        if (this.cartData.length > 0) {
            this.data.forEach(function (el1) {
        ...
        if (this.cartData.length > 0) {
            if (this.data) {
                this.data.forEach(function (el1) {
                    el1.items.forEach(function (item) {
                        item.qty = 0;
                        var fCart = _this.cartData.find(function (x) { return x.id == item.id; });
                        if (fCart) {
                            item.qty = fCart.qty;
                        }
                    });
    ...
    CategoryDetailPage.prototype.AddCart = function (item) {
        item.qty = item.qty + 1;
    ...
    CategoryDetailPage.prototype.remove = function (item) {
        var equalIndex;
        if (item.qty == 0)
            return;
        item.qty = item.qty - 1;
    ...
    CategoryDetailPage.prototype.cart = function () {
        if (this.cartData.length == 0) {
    ...
    CategoryDetailPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-category-detail-category-detail-module-es5.js.map