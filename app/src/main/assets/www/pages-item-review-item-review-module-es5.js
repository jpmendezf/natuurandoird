...
var ItemReviewPageModule = /** @class */ (function () {
    function ItemReviewPageModule() {
    }
...
var ItemReviewPage = /** @class */ (function () {
    function ItemReviewPage(api, util) {
        var _this = this;
        this.api = api;
        this.util = util;
        this.data = [];
    ...
    ItemReviewPage.prototype.ngOnInit = function () { };
    ItemReviewPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-item-review-item-review-module-es5.js.map