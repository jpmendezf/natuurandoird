...
let GetOtpPageModule = class GetOtpPageModule {
};
...
let GetOtpPage = class GetOtpPage {
    ...
    goHome() {
        this.data.otp =
            this.opt.a +
                ...
                this.opt.f;
        this.util.startLoad();
        this.api.postData("checkOtp", this.data).subscribe((res) => {
            if (res.success) {
    ...
    resendOtp() {
        ...
        this.util.startLoad();
        this.api.postData("resendOTP", this.data).subscribe((res) => {
            if (res.success) {
                this.util.dismissLoader();
...
//# sourceMappingURL=pages-get-otp-get-otp-module-es2015.js.map