...
var GroceryCartPageModule = /** @class */ (function () {
    function GroceryCartPageModule() {
    }
...
var GroceryCartPage = /** @class */ (function () {
    function GroceryCartPage(nav, gpi, api, util, nativeGeocoder) {
        var _this = this;
        this.nav = nav;
        this.gpi = gpi;
        this.api = api;
        ...
        this.data.forEach(function (element) {
            _this.totalItem += element.sell_price * element.qty;
        });
        this.toPay =
            this.totalItem +
        ...
        this.api
            ...
            if (res.success) {
                ...
                _this.charge = _this.store.delivery_charge;
                if (_this.store.delivery_type == "Shop") {
                    _this.event = "pickup";
                    _this.store.delivery_charge = 0;
                }
                else if (_this.store.delivery_type == "Home") {
                    _this.event = "delivery";
                }
                else {
                    _this.event = "delivery";
                }
                ...
                _this.api
                    ...
                    if (res.success) {
                        ...
                        _this.mapData();
                        _this.data.userlat = res.data.lat;
                        _this.data.userlang = res.data.lang;
                    }
                }, function (err) {
                    _this.util.dismissLoader();
                });
    ...
    GroceryCartPage.prototype.ionViewWillEnter = function () {
        var _this = this;
    ...
    GroceryCartPage.prototype.initMap = function () { };
    GroceryCartPage.prototype.ngOnInit = function () { };
    GroceryCartPage.prototype.paymentMethod = function () {
        if (this.data.length) {
    ...
    GroceryCartPage.prototype.applyCoupon = function () {
        if (this.data.length) {
    ...
    GroceryCartPage.prototype.countDiscount = function () {
    ...
    GroceryCartPage.prototype.minusQty = function (item) {
        var equalIndex;
        if (item.qty != 1) {
            item.qty--;
            this.totalItem -= item.sell_price;
            ...
            var equalIndex_1;
            this.cartData.forEach(function (element, ind) {
                if (element.id == item.id) {
                    equalIndex_1 = ind;
                }
            });
            if (equalIndex_1 >= 0) {
                if (item.qty == 0) {
                    item.qty = 0;
                    this.cartData.splice(equalIndex_1, 1);
                    this.totalItem -= item.sell_price;
                    item.total = item.qty * item.sell_price;
                    this.toPay =
                        this.totalItem +
                    ...
                    this.cartData[equalIndex_1] = item;
                    item.total = item.qty * item.sell_price;
                    item.total = item.qty * item.sell_price;
                    this.toPay =
                        this.totalItem +
    ...
    GroceryCartPage.prototype.change_Address = function () {
        this.chaneAddress = true;
        this.nav.navigateForward("/select-address");
    };
    GroceryCartPage.prototype.distance = function (lat1, lon1, lat2, lon2, unit) {
    ...
    GroceryCartPage.prototype.segmentChanged = function () {
    ...
    GroceryCartPage.prototype.mapData = function () {
        var _this = this;
        this.FindAddress =
        ...
        this.nativeGeocoder
            ...
            _this.destination = {
                lat: parseFloat(_this.store.latitude),
                lng: parseFloat(_this.store.longitude),
            };
            _this.origin = {
                lat: parseFloat(result[0].latitude),
                lng: parseFloat(result[0].longitude),
    ...
    GroceryCartPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-grocery-cart-grocery-cart-module-es5.js.map